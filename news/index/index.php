...
//
//  ga('create', 'UA-11803823-3', 'auto');
//  ga('send', 'pageview');
  
  
      var _gaq = _gaq || [];
    _gaq.push(['_setAccount', 'UA-11803823-3']);
    _gaq.push(['_setDomainName', 'nostale.gameforge.com']);
...
function loadNews(page) {
	$.ajax({url:"http://de.nostale.gameforge.com/ajax/news/morenews/" + page,
			success: function(data){
						// put the news into the page
						if(data != false) { 
							$('div.newscontent').html(data);
							$('#older').attr("onclick","loadNews(" + (page + 1) + ")");
							if(page > 0) {
								$('#newer').attr("onclick","loadNews(" + (page - 1) + ")");
								$('#newer').removeClass("inaktiv");
							} else {
								$('#newer').addClass("inaktiv");
							}	
						}
					}
			});	
...
function loadMedia(media) {
	$.ajax({url:"http://de.nostale.gameforge.com/ajax/news/" +media,
			success: function(data){
						// put the news into the page
						$('#mediaWrapper').html(data);
						$('#med_artworks').attr("class","");
						$('#med_wallpapers').attr("class","");
						$('#med_comics').attr("class","");
						$('#med_screenshots').attr("class","");
						$('#med_videos').attr("class","");
						//set new activ class
						$('#med_'+media).attr("class","active");
					}
			});	
}

function searchCategory() {
	$.ajax({url:"http://de.nostale.gameforge.com/ajax/news/changefilter/" + $("#categorySelect option:selected").attr("value"),success: function() { window.setTimeout("loadNews(0)",500);}});	
}
</script>
<div id="index">
    <div class="col_2_wrapper" >
        <a name="allNewsContent"></a>
        <div class="col_1" id="allNewsContent">
            <div class="content_box ">
                                <div id="topNews">
                    <h1 class="main-headline">Topaktuell</h1>
                    	                	<div id="topNewsImageWrapper" >
	                        <div id="topNewsImage">
	                            <img src="\images\news\topaktuell_pic.png"/>
	                            <div class="news_content clearfix">
	                                <h2><center>NosSite - Version: <?php echo $version; ?></center></h2>
		                         </div>
	                        </div>
	                    </div>
	                                </div>
                                <div id="newsMainHeadline">                    
                     <h1>News</h1>
                      <div id="categorySelectWrapper">
                        <select id="categorySelect" class="select_skin" onchange="searchCategory()"> 
                            <option value="-1" >Alles</option>
                                                        <option value="0" >Updates</option>
                                                        <option value="1" >Shop</option>
                                                        <option value="2" >Sonstiges</option>
                                                        <option value="3" >Unkategorisiert</option>
                                                        <option value="4" >Events</option>
                                                        <option value="5" >Fanart</option>
                                                        <option value="6" >Quiz</option>
                                                        <option value="7" >Fan-Made</option>
                                                        <option value="8" >Tipps und Tricks</option>
                                                    </select>
                    </div>
                </div>
                <div class="newscontent">
                                            <!-- START News-Vorschau -->
                        <article class="news" id="1">
                            <header class="article_header">
                                ...
                                <span class="info_text">
                                                                        Von Username (Rang) in <a href="">Kategorie</a> - Datum                                </span>
                            </header>
                            <div class="article_content">
                                <div class="article_text">
                                                                            <div class="newsSmallPicture"><img width="126" height="126" src="/images/news/news-pic1.png" class="attachment-thumbnail size-thumbnail" alt="" /></div>
                            ...
                            <footer class="article_footer">
                                <a href=""  class="comments">
                                    <span> </span>
                                    Anzahl                                </a>
                                <a href="" class=" details arrow_right_dark arrow">
                                    Details                                    <span> </span>
                                </a>
                            </footer>
                        </article>
            ...
            <!-- <div id="newsNavigation">
                <a href="#allNewsContent" id="newer" class="inaktiv arrow arrow_left_dark">
                    <span> </span>
                    neuere                </a>
                <a href="#allNewsContent" id="older" class="arrow arrow_right_dark" onclick="loadNews(1);">
                    ältere                    <span> </span>
                </a>
                <div class="clear"></div>
            </div>-->
        ...
        <div class="col_2"> 
        	            <div class="content_box info_box" id="crosspromo_div" style="visibility:hidden;">
  <h1>Jetzt spielen!</h1>
  <div class='info_box_content' id="crosspromo_div_inner">

   
         <noscript><a href='http://delivery.ads.gfsrv.net/ck.php?n=ae75bb57&amp;cb=1608136897391863040' target='_blank'><img src='http://delivery.ads.gfsrv.net/avw.php?zoneid=2063&amp;cb=1608136897391863040&amp;n=ae75bb57' border='0' alt='' /></a></noscript>
                           
    
  
  <script type="text/javascript">
    var crosspromoElem = document.getElementById('crosspromo_div_inner');
      if(crosspromoElem.children.length <= 4 ){
        var control = document.getElementById('crosspromo_div');
        control.parentNode.removeChild(control);
      }
      else
      {
       document.getElementById('crosspromo_div').style.visibility="visible";; 
      }
     </script>
  </div>
</div>
    ...
    <h1>Title</h1>
    <div class="info_box_content" id="playNowBox">
    	<img src="//gf2.geo.gfsrv.net/cdnde/f2389f554e50adbda8d87d29ca278d.png" />
        <a id="downloadNowButton" href="">
            <span class="icon"></span>
            Zur Downloadversion        </a>
    </div>
</div>
     <div id="followUs">
   <div class="content_box "  style="margin-right: 0px;">
      <h1>Folge uns!</h1>
...
</div>            <!-- START Forum-Teaser -->
		<!-- <div id="boardTeaser">
		<div class="content_box info_box content_box_bottom_link">
	        <h1>Forenticker</h1>
	        <div class="info_box_content">
	            
	            	                	                <div class="board_teaser">
	                    <div class="info_text">
	                        Flug-Zeug | 10. September  15:22	                    </div>
	                    <a href="http://board.de.nostale.gameforge.com//index.php?page=Thread&amp;threadID=257359" target="_board">
	                        <span class="board_icon"> </span>
	                        Zeitreset Rufshop	                        <span class="external_link"></span>
	                    </a>
	                </div>
	                	            	                	                <div class="board_teaser">
	                    <div class="info_text">
	                        julians13 | 10. September  14:53	                    </div>
	                    <a href="http://board.de.nostale.gameforge.com//index.php?page=Thread&amp;threadID=257358" target="_board">
	                        <span class="board_icon"> </span>
	                        abtrünniger 99+8 für ldt	                        <span class="external_link"></span>
	                    </a>
	                </div>
	                	            	                	                <div class="board_teaser">
	                    <div class="info_text">
	                        InVortex | 10. September  10:36	                    </div>
	                    <a href="http://board.de.nostale.gameforge.com//index.php?page=Thread&amp;threadID=257357" target="_board">
	                        <span class="board_icon"> </span>
	                        *Sonstiges Gold Gold Gold	                        <span class="external_link"></span>
	                    </a>
	                </div>
	                	            	                	                <div class="board_teaser">
	                    <div class="info_text">
	                        Mystogan² | 10. September  1:00	                    </div>
	                    <a href="http://board.de.nostale.gameforge.com//index.php?page=Thread&amp;threadID=257356" target="_board">
	                        <span class="board_icon"> </span>
	                        Gold Tausch	                        <span class="external_link"></span>
	                    </a>
	                </div>
	                	            	                	                <div class="board_teaser">
	                    <div class="info_text">
	                        MiLLiOnGirl | 9. September  21:33	                    </div>
	                    <a href="http://board.de.nostale.gameforge.com//index.php?page=Thread&amp;threadID=257355" target="_board">
	                        <span class="board_icon"> </span>
	                        Bogenschütze Accountauflösung By Melo	                        <span class="external_link"></span>
	                    </a>
	                </div>
	                	            	        </div>
	        <a class="bottom_link" href="http://de.nostale.gameforge.com/main/board"  target="_board">
	            <span> </span>
	            Zum Forum	        </a>
	    </div>
	</div> -->
	<!-- ENDE Forum-Teaser-->            <!-- START Highscores -->
<!-- <div class="content_box info_box  content_box_bottom_link" id="highscoreInfoBox">
	<h1>Highscore</h1>                
    <div class="info_box_content">
    		...
    		<p class="bold">
           		Hier unsere Top 10 der besten Spieler:           	</p>
           	<table border="0" class="rank">
              	<thead>
              		<tr>
                        <th>
            ...
            <div id="selectServer">
                ...
                <select onchange="callhighscore();" name="serverchoice" class="select_skin" id="serverchoice" onchange="submit();">
            ...
            <p colspan="3" class="info_text right_text"> 
                Update: 2016-09-10 02:08:19            </p>
   		 
	</div>
    <a class="bottom_link" href="http://de.nostale.gameforge.com/main/highscore">
        <span></span>
        Zu den Highscores    </a>
</div>
-->
<!-- ENDE Hightscores-->        </div>
        <div class="clear" > </div>
    </div>
